...
// Colors
export const COLOR_SHIP = '#00FFCC'; // Neon Cyan
export const COLOR_ENGINE = '#FF00FF'; // Magenta
export const COLOR_ASTEROID = '#888888';
export const COLOR_UFO = '#00FF00'; // Neon Green
